...
<%    
    Response.Write "<td style=""" & g_search_style & """> " & g_text_search & "&nbsp;<input type=""text"" name=""yider"" size=""" & g_search_box_length & """ maxlength=""100"" value=""" & replace(Request("yider"), """", "&quot;") & """></td>"
%>

    <!--Graphical button start-->
    <td>
      &nbsp;<a href="" onClick="OnSearch(document.yider_form); return false;"><img src="<%Response.Write g_button_filename%>" border="0"></a>&nbsp;
    </td>
    <!--Graphical button end-->
